...
@@ -351,6 +550,54 @@ def write_run_json(run_dir, plan_path, spec_path, status, task_summaries):
     return path
...
+        _clear_task_receipts(run_dir, task.number)
         ...
         task_summaries.append(
             {
@@ -472,12 +802,36 @@ def run_plan(plan_path, spec_path, run_dir, codex_bin, cwd):
         else:
...
+        )
         ...
         self.assertFalse(
@@ -484,5 +541,393 @@ class LoopSubprocessTests(unittest.TestCase):
