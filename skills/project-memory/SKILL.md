---
name: project-memory
description: Use when logging a decision made about the system, recording deferred work, or updating the project roadmap — and as the format reference for docs/theforge/ROADMAP.md, DECISIONS.md, and DEFERRALS.md.
---

# Project Memory

Three append-friendly files under `docs/theforge/` give the project durable memory across sessions. Entries are terse, newest first. Create each file on its first entry — no empty scaffolds. Commit memory updates with the work that produced them.
...
**Where:** docs/theforge/specs/2026-06-10-storage-design.md
```
...
**From:** docs/theforge/plans/2026-06-10-sync.md, Task 3
...
A repo with `docs/superpowers/` and no `docs/theforge/`: offer a one-time `git mv docs/superpowers docs/theforge` rather than reading both paths forever.
